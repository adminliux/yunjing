...
#content2{ width:710px; height:415px; margin:0 auto;}
...
<body>
        ...
        <div class="center">
        <div class="center_s">
          <img src="/images/pic_error.gif" width="53" height="60" />
          <b>错误提示</b>
          </div>
          <div class="center_x">
          <div class="divv1">${errorMsg}</div>
          <div class="divv2">建议你 <em>刷新</em> 之后重新操作 </div>
          </div>
        </div>
        </div>
</body>
